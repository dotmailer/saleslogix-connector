<script language="javascript" type="text/javascript">
    ...
    function mt_ClearFilters()
    {
        ...
        if (control != null)
        {
            control.childNodes[0].value = "";
            control.childNodes[1].value = "";
        }
	...
	function OnTabLookupMemberClick()
	{
	    SetDivDisplay("@mt_divAddFromGroupId", "none");	
	    SetDivDisplay("@mt_divLookupMembersId", "inline");
	    
	    SetTabDisplay("@mt_tabLookupMemberId", "activeTab tab");
	...
	{
	    SetDivDisplay("@mt_divLookupMembersId", "none");
	    SetDivDisplay("@mt_divAddFromGroupId", "inline");
	    
	    SetTabDisplay("@mt_tabLookupMemberId", "inactiveTab tab");
