<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AddAddressBookMembers.ascx.cs" Inherits="AddAddressBookMembers" %>
...
.inactiveTab .tabright
{
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="AddAddressBookMembers_RTools" ToolbarLocation="right">
  <SalesLogix:PageLink ID="lnkAddAddressBookMembersHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="AddAddressBookMembers" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
...
<div id="heightRestrictor" style="height:550px;">
<div id="tabStripArea" style="padding:5px,0px,0px,20px">
    <asp:Panel id="tabLookupMembers" runat="server" CssClass="activeTab">
	    <div class="tableft">&nbsp;</div>
		<div class="tabcenter">
		    <asp:Localize ID="lclTabLookupMembers" runat="server" 
                Text="<%$ resources:tabLookupMembers.Caption %>"></asp:Localize>
		</div>
...
<div style="margin:0px,10px,0px,10px; border: 1px solid #b5cbe0">
    <div runat="server" id="divLookupMembers">
...
<div style="margin:0px,10px,0px,10px; border: 1px solid #b5cbe0">
    <table border="0" cellpadding="1" cellspacing="0" class="formtable">
        ...
        <tr>
            <td>
                <SalesLogix:SlxGridView runat="server" ID="grdMembers" GridLines="None" AutoGenerateColumns="false" CellPadding="4"
                    ...
                    PageSize="20" OnPageIndexChanging="grdMemberspage_changing" ExpandableRows="True" AllowSorting="true"
                    OnSorting="grdMembers_Sorting" ShowEmptyTable="true" EmptyTableRowText="<%$ resources: grdMembers.EmptyTableRowText %>" >
                    <Columns>
                        <asp:BoundField DataField="FirstName" HeaderText="<%$ resources: grdMembers.FirstName.ColumnHeading %>"
                            SortExpression="FirstName" />
                        <asp:BoundField DataField="LastName" HeaderText="<%$ resources: grdMembers.LastName.ColumnHeading %>"
                            SortExpression="LastName" />
                        <asp:BoundField DataField="Company" HeaderText="<%$ resources: grdMembers.Company.ColumnHeading %>"
                            SortExpression="Company" />
                        <asp:TemplateField HeaderText="<%$ resources: grdMembers.Email.ColumnHeading %>" SortExpression="Email">
                            <itemtemplate>
                                <SalesLogix:Email ID="Email1" runat="server" DisplayMode="AsHyperlink" Text='<%# Eval("Email") %>'></SalesLogix:Email>
                            </itemtemplate>
                        </asp:TemplateField>
                        <asp:BoundField DataField="City" HeaderText="<%$ resources: grdMembers.City.ColumnHeading %>"
                            SortExpression="City" />
                        <asp:BoundField DataField="State" HeaderText="<%$ resources: grdMembers.State.ColumnHeading %>"
                            SortExpression="State" />
                        <asp:BoundField DataField="Zip" HeaderText="<%$ resources: grdMembers.Zip.ColumnHeading %>"
                            SortExpression="Zip" />
                        <asp:TemplateField HeaderText="<%$ resources: grdMembers.WorkPhone.ColumnHeading %>" SortExpression="WorkPhone" >
                            <itemtemplate>
        ...
        <tr id="row"14">
            <td id="row14col5">
                <asp:Panel runat="server" ID="ctrlstAddCancel" CssClass="controlslist qfActionContainer">
                    <asp:Button runat="server" ID="cmdAddMembers" OnClick="AddMembers_OnClick" Text="<%$ resources: cmdAdd.Caption %>" CssClass="slxbutton"/>
