...
/// <summary>
/// Summary description for EmailSendSendSummaries
/// </summary>
public partial class EmailSendSendSummaries : EntityBoundSmartPartInfoProvider
{
    /// <summary>
    ...
    {
        get { return typeof(Sage.Entity.Interfaces.IEMEmailCampaignSend); }
    }
    ...
    {
        IEMEmailCampaignSend emailCampaignSend = (IEMEmailCampaignSend)this.BindingSource.Current;
        ...
        criteria.Add(ef.Eq("EMEmailCampaignSend.Id", emailCampaignSend.Id));
