<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EmailSendSendSummaries.ascx.cs" Inherits="EmailSendSendSummaries" %>
 ...
 Visible="false" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdCampaignSendSummaries_Contacts_Changing" >
    <Columns>
        ...
        <asp:TemplateField   HeaderText="<%$ resources: grdCampaignSendSummaries_Contacts.WorkPhone.ColumnHeading %>" >
            <itemtemplate>
                <SalesLogix:Phone runat="server" Text='<%# ProcessEvalData("ContactWorkPhone", Eval("SlxContactId"), "Contact") %>' DisplayAsLabel="true" ></SalesLogix:Phone>
            </itemtemplate>
        </asp:TemplateField>
        <asp:TemplateField   HeaderText="<%$ resources: grdCampaignSendSummaries_Responses.DateSent.ColumnHeading %>" >
            <itemtemplate>
...
<SalesLogix:SlxGridView runat="server" ID="grdCampaignSendSummaries_Leads" GridLines="None" AutoGenerateColumns="false"
 ...
 Visible="false" AllowPaging="true" PageSize="10" OnPageIndexChanging="grdCampaignSendSummaries_Leads_Changing" >
    <Columns>
        ...
        <asp:TemplateField   HeaderText="<%$ resources: grdCampaignSendSummaries_Leads.Company.ColumnHeading %>" >
            <itemtemplate>
                <asp:Literal runat="server" Text='<%# ProcessEvalData("LeadCompanyName", Eval("SlxLeadId"), "Lead") %>' ></asp:Literal>
            </itemtemplate>
        </asp:TemplateField>
 ...
 <SalesLogix:SmartPartToolsContainer runat="server" ID="EmailSendSendSummaries_RTools" ToolbarLocation="right">
  <SalesLogix:PageLink ID="lnkEmailSendSendSummariesHelp" runat="server" LinkType="HelpFileName" ToolTip="<%$ resources: Portal, Help_ToolTip %>" Target="MCWebHelp" NavigateUrl="EmailSendSendSummaries" ImageUrl="~/ImageResource.axd?scope=global&type=Global_Images&key=Help_16x16"></SalesLogix:PageLink>
